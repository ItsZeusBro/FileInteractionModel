...
5. a.Stream(b.pre(script1), quant, p1, p2).post(script2)          //Continuous Stream until quant reached (a p1 is the postition after which you wish to stream. b p2 is the position after which you stream the data to.)
